...
export default function NotFound() {
    return (
        <>
            <main className="grid min-h-full place-items-center bg-white px-6 py-[20rem] sm:py-[15rem] lg:px-8 lg:py-[10rem]">
                <div className="text-center">
                    <p className="text-base font-semibold text-[#0CA9E8]">404</p>
