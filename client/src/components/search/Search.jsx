    ...
    return (
        <>
            ...
            <div className="flex items-center justify-center relative">
                <div className="flex rounded-full bg-[#fff] px-2 w-full max-w-[600px] border-2 border-solid border-[#0CA9E8]">
                    ...
                    <input
                        type="text"
                        className="w-full bg-[#0d1829] flex bg-transparent pl-2 text-gray outline-0 "
                        placeholder="Search location"
                    />
                    <button type="submit" className="relative p-2 bg-[#fff] rounded-full">
                        <svg
                            width="30px"
                            height="30px"
                            viewBox="0 0 24 24"
